...
const guildChannelMap: GuildData = {
    "1231453115937587270": {
                ...
                "embeds": [
                    {
                        ...
                        "fields": [
                            {
                                "name": "**__AutoMod__**",
                                "value": "__Warnings__:\nFor each warn you recieve there will be a 24 hour timer set, after 24 hours your first warn will expire. Eg: you recieve one warn today and then another warn 6 hours later, the next day your first warn will expire but will keep the second warn active.\n\n__media__:\n\nYou can only post media once per 5 messages. This is at a per user level so someoneelse posts media, you will not be flagged for it"
                            },
                            {
                                "name": "**__NSFW Rules__** ",
                                "value": "13. All art should be posted in <#1257424392586002613>.\n 14. Please post any VRChat NSFW pictures in <#1257407956408995890>.\n",
                                "inline": false
                            },
                            {
                                "name": "**__RolePlay__**:performing_arts: ",
                                "value": "15.  Keep general roleplay actions concise. Longer actions and detailed descriptions have their own dedicated channel.\n16. Erotic Roleplay is not permitted in general or roleplay channels. For Roleplays involving weapons, please use <#1257099297053343878>.\n"
                            },
                            {
                                "name": "**__Voice channels__**:speaking_head: ",
                                "value": "17.  Keep your microphone at a reasonable volume.\n\n18.  Sound Boards are disabled\n\n19. if using a camera, please ensure content remains Safe For Work (SFW). This means avoiding nudity or excessivley revealing attire beyond typical arms, face, and leg exposure.\n\n20.  if you are consuming adult substances (e.g., alcohol, smoking, vaping), please ensure it does not impair your behavior or disrupt others. Excessive intoxication may result in removal from the voice channel.\n\n21. Repeatedly joining and leaving a voice channel is discouraged as it can be disruptive to ongoing conversations or active streams.\n\n",
                                "inline": false
                            },
                            {
                                "name": "**__Profile Content:__** ",
                                "value": "Profile pictures (PFPs) and banners must be cropped to exclude explicit NSGW content, particularly for the safety of minor users.\n\nBios containing racial slurs or hate speech are strictly prohibited. Such content will result in a prompt request to change your bio, or immediate removal from the server.",
                                "inline": false
                            },
                            {
                                "name": "**__Leveling System:__**",
                                "value": "To prevent spam and abuse, new members are required to reach level 3 via <@1420927654701301951> to gain permissions for features such as posting GIFs and joining voice channels.",
                                "inline": false
                            },
                            {
                                "name": "**__Roles__**",
                ...
                "embeds": [
                    {
                        ...
                        "fields": [
                            {
                                "name": "Suicide Crisis Hotlines - Emergency Numbers",
        ...
        mediaexclusions: {
            ...
            "media": "1308662226256924672",
            "yourart": "1432405139393740910",
            "fan art": "1423410265092919376",
            "nsfwvrc": "1257407956408995890",
            ...
            "getRoles": {
                ...
                "embeds": [
                    ...
                    },
                    {
                        ...
                        "description": "It\"s a small but fun way to express yourself and stand out from the crowd. Just click on any of the colors below and make it your own. And remember, you can always change your color whenever you feel like it!Thank you for being a part of our friendly community.\n\n🔴: <@&1347447588919443557>\n🟣: <@&1347447590928519199>\n🟢: <@&1347447605847920640>\n🔵: <@&1347447594690805933>\n🟤: <@&1347447591901859882>\n"
                    }
                ],
                "components": [
                    {
    ...
    "1342845801059192913": {
        messageConfigs: {
            ...
            "getroles": {
                ...
                "embeds": [
                    {
                        "description": "Get your age role here. Lying about your age is punishable up to a ban depending on severity:\n🔞: <@&1388113103081705502>\n👨: <@&1388111992287400089>\n"
                    }
                ],
                "reactions": [
                    "🔞",
